...
namespace Model
{
    ...
    public class CHCNetSDK
    {
        ...
        public struct NET_DVR_ALARMINFO_V40
       {
        ...
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_DVR_Channel_PARAM
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;   // 保留字节 
            public float  fChannelHeight;    // 摄像机高度
            public float  fChannelAngle;     // 摄像机俯仰角度
        ...
        public struct NET_DVR_BEHAVIOR_OUT_CALIBRATION
        {
            ...
            public NET_DVR_Channel_PARAM  struChannelParam;    // 摄像机参数
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        //前端参数配置
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_DVR_ChannelPARAMCFG
        {
            public uint dwSize;
        ...
        //前端参数配置
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_DVR_ChannelPARAMCFG_EX
        {
            public uint dwSize;
            public NET_DVR_VIDEOEFFECT struVideoEffect;/*亮度、对比度、饱和度、锐度、色调配置*/
            public NET_DVR_GAIN struGain;/*自动增益*/
       ...
       public enum NET_SDK_DOWNLOAD_STATUS
       {
        ...
        /*摄像机信息,最多9999个，从1开始 */
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_MATRIX_ChannelINFO
        {  
        ...
        {
            public uint dwSize;
            public uint dwMaxChannelNum;//最大Channel数量
        ...
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_DVR_ACCESS_Channel_INFO
        {
            public uint dwSize;
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 32)]
            public string sChannelInfo;		// 前端相机信息
        ...
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_DVR_Channel_DEHAZE_CFG
        {
            public uint dwSize;
        ...
        //设置前端相机类型状态
        public const int SET_Channel_TYPE_SUCCESS = 1;  // 成功
        public const int SET_Channel_TYPE_FAIL = 2;  // 失败
        public const int SET_Channel_TYPE_PROCESSING	= 3;   // 正在处理
		...
		**********************************************************/
        ...
        public enum VCA_RECOGNIZE_SCENE
        {
            ...
            VCA_MOBILE_Channel_SCENE = 2,//移动摄像机应用） 
        }
        ...
        */
        ...
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct tagChannelPARAMCFG
        {
            public uint dwSize;
        ...
        ******************************************************************************/
        ...
        [DllImport("RecordDLL.dll")]
        public static extern int OpenChannelRecord(string strChannelid, IntPtr pHead, uint dwHeadLength);
